/**
 * company-service/src/messaging/rpc.client.ts
 *
 * Generic RabbitMQ RPC client (same pattern as user-service).
 */
...
async function connect(): Promise<void> {
  ...
  try {
    ...
    connection = await amqp.connect(uri, {
      clientProperties: { connection_name: 'company-service-rpc-client' },
    });
